SchemeFinderFrontend::Application.configure do
  ...
  config.after_initialize do
    SchemeFinderFrontend.configure do |app_config|
      ...
      app_config.ssl = true
      app_config.google_analytics_tracker = "UA-61230490-1"
      app_config.google_analytics_domain = "'auto'" # domain could be executable code as well
    end
  end
end
